...
class DiaUtilsLibsModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: DiaUtilsLibsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.7", ngImport: i0, type: DiaUtilsLibsModule, imports: [CommonModule,
            FormsModule,
            ReactiveFormsModule,
            MatFormFieldModule,
            MatInputModule,
            ...
            MatDatepickerModule,
            MatTooltipModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: DiaUtilsLibsModule, imports: [CommonModule,
            FormsModule,
            ReactiveFormsModule,
            MatFormFieldModule,
            MatInputModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: DiaUtilsLibsModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [],
                    imports: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: InputDatePicker, decorators: [{
            type: Component,
        ...
        }], ctorParameters: () => [{ type: i1$2.DateAdapter }], propDecorators: { label: [{
                type: Input
            }], customDatePicker: [{
                type: Input
            }], placeholder: [{
...
class IsNumericDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: IsNumericDirective, deps: [{ token: i0.ViewContainerRef }, { token: i0.Renderer2 }], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.7", type: IsNumericDirective, isStandalone: true, selector: "[appIsNumeric]", inputs: { isDecimal: "isDecimal", disable: "disable", appIsNumeric: "appIsNumeric" }, host: { listeners: { "keydown": "onkeyup($event)", "paste": "blockPaste($event)" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: IsNumericDirective, decorators: [{
            type: Directive,
            args: [{
...
class ClickedOutsideDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: ClickedOutsideDirective, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.7", type: ClickedOutsideDirective, isStandalone: true, selector: "[appClickedOutside]", inputs: { looseCheck: "looseCheck", trackEphemeraElement: "trackEphemeraElement", hasleftFor: "hasleftFor", compList: "compList", debug: "debug" }, outputs: { hasLeft: "hasLeft", clickedOutside: "clickedOutside", blur: "blur", compListChange: "compListChange" }, host: { listeners: { "document:click": "onclick($event.target)", "mousemove": "onmouseover($event.target)", "mouseleave": "onmouseleave($event.target)" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: ClickedOutsideDirective, decorators: [{
            type: Directive,
            args: [{
...
class InputRangeDate {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: InputRangeDate, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.7", type: InputRangeDate, isStandalone: true, selector: "lib-input-range-date", ngImport: i0, template: "<p>input-range-date works!</p>\n", styles: [""] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: InputRangeDate, decorators: [{
            type: Component,
...
class Table {
    ...
    paginationChanged = new EventEmitter();
    ...
    compareNumber(a, b, d) {
        return ((this.string2number(a) < this.string2number(b) ? -1 : 1) *
            (d === 'asc' ? 1 : -1));
    }
    sortData(sort) {
        ...
        for (const element of this.dynamicColumns) {
            if (sort.active === element.columnDef) {
                if (element.isNumeric) {
                    this.datasource.data = data.sort((a, b) => {
                        return this.compareNumber(element.cell ? element.cell(a) : 0, element.cell ? element.cell(b) : 0, sort.direction);
                    });
                }
                else if (element.specificSort) {
                    this.datasource.data = data.sort((a, b) => {
                        return element.specificSort(element.cell ? element.cell(a) : null, element.cell ? element.cell(b) : null, sort.direction);
                    });
                }
                else {
                    this.datasource.data = data.sort((a, b) => {
                        return this.compare(element.cell ? String(element.cell(a)) : '', element.cell ? String(element.cell(b)) : '', sort.direction);
                    });
                }
                break;
            }
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: Table, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.7", type: Table, isStandalone: true, selector: "dia-table", inputs: { source: "source", pageSize: "pageSize", selected: "selected", noPagination: "noPagination", loading: "loading", dynamicColumns: "dynamicColumns", filterValue: "filterValue", isTitleOnTop: "isTitleOnTop", requestCount: "requestCount", isElasticSearch: "isElasticSearch", trServ: "trServ", tdTemplate: "tdTemplate" }, outputs: { rowClicked: "rowClicked", rowDblClicked: "rowDblClicked", sourceChange: "sourceChange", paginationChanged: "paginationChanged", sortChanged: "sortChanged" }, viewQueries: [{ propertyName: "paginator", first: true, predicate: MatPaginator, descendants: true }, { propertyName: "sort", first: true, predicate: MatSort, descendants: true }], usesOnChanges: true, ngImport: i0, template: "<div class=\"table-container\">\n  <div class=\"table-content\" [ngClass]=\"titleOnTop\">\n    <table mat-table [dataSource]=\"datasource\" matSort (matSortChange)=\"sortData($event)\"\n      matSortActive=\"numeroFL\" matSortDirection=\"desc\" matSortDisableClear\n      [matSortDisableClear]=\"true\" class=\"mat-table-dossier-list\">\n      <ng-container *ngFor=\"let column of dynamicColumns\" [matColumnDef]=\"column.columnDef || ''\">\n        <th mat-header-cell *matHeaderCellDef mat-sort-header [disabled]=\"!column.sort\" class=\"{{ titleOnTop }}\" [ngClass]=\"column.forbiddenScreens || ''\">{{ column.header }}</th>\n        <td mat-cell *matCellDef=\"let row\" (click)=\"oncellclick(column, row)\"\n        class=\"{{ titleOnTop }} {{column && column.onclick ? 'clickable' : ''}} {{ column.class || '' }} class_{{ column.classEqualsRowValue && column.cell ? column.cell(row) : '' }}\"\n        [ngClass]=\"column.forbiddenScreens || ''\" [matTooltip]=\"column.tooltip && column.cell ? column.cell(row) : ''\"\n          [matTooltipPosition]=\"'above'\">\n          @if (column.custom) {\n            <div>\n              <ng-container *ngTemplateOutlet=\"tdTemplate; context: {$implicit:{row:row, column:column}}\"></ng-container>\n            </div>\n          } @else {\n            @if (column.type) {\n              <mat-icon>{{ getColumnValue(column, row) }}</mat-icon>\n            } @else {\n              {{ getColumnValue(column, row) }}\n            }\n            @if (column.checkbox) {\n              <mat-checkbox [checked]=\"row.checked\" (change)=\"oncheckclick(column, row)\"></mat-checkbox>\n            }\n          }\n        </td>\n      </ng-container>\n      <tr mat-header-row *matHeaderRowDef=\"displayedColumns\" [ngClass]=\"titleOnTop\"></tr>\n      <tr mat-row [ngClass]=\"{selectedRow:selected && selected(row), clickable: selected}\" (mouseover)=\"itemBeenRead(row)\" (click)=\"_onRowClicked(row)\"\n        (dblclick)=\"_onRowDblClicked(row)\" *matRowDef=\"let row; columns: displayedColumns\"></tr>\n    </table>\n\n    <div [ngClass]=\"{'pagination': true, 'hide-pagination': noPagination}\">\n      <mat-paginator (page)=\"pageEvent = $event; pageSize = $event.pageSize\" [pageSizeOptions]=\"[5, 10, 20, 50]\" [pageSize]=\"pageSize\"></mat-paginator>\n    </div>\n  </div>\n</div>\n", styles: [".hide{display:none}.table-container{overflow:auto;width:100%;padding:.9375rem 0;position:relative;background-color:#f8f9fa}.table-container tr.mat-row:hover td{background-color:#e6e6e6}.table-container .table-content.titleUpperTable{margin-top:2.5rem}.table-container .table-content.titleUpperTable table{margin-top:-3.5rem;background:transparent}.table-container .table-content{border:2px solid #e6e6e6;border-radius:1.3125rem;padding:0 .9375rem .9375rem;background-color:#fff}.table-container .table-content tr.mat-header-row.titleUpperTable{background:transparent}.table-container .table-content td.mat-cell:first-child{padding-left:10px}.table-container .table-content td.mat-cell:last-child{padding-right:10px}.table-container .table-content td.mat-cell{touch-action:auto!important;-webkit-user-select:auto!important;user-select:auto!important;-webkit-user-drag:auto!important}.table-container .table-content .mat-table-dossier-list{width:100%}.table-container .table-content .mat-table-dossier-list th.mat-header-cell:first-child{padding-left:10px}.table-container .table-content .mat-table-dossier-list th.mat-header-cell:last-child{padding-right:10px}.table-container .table-content .mat-table-dossier-list th.mat-header-cell:hover ::ng-deep .mat-sort-header-container .mat-sort-header-arrow{display:inline}.table-container .table-content .mat-table-dossier-list th.mat-header-cell.titleUpperTable{min-width:1.5rem;overflow:hidden;text-overflow:ellipsis}.table-container .table-content .mat-table-dossier-list th.mat-header-cell.titleUpperTable ::ng-deep .mat-sort-header-container:after{margin-left:-14px}.table-container .table-content .mat-table-dossier-list th.mat-header-cell.titleUpperTable:first-child{width:10px;min-width:10px}.table-container .table-content .mat-table-dossier-list th.mat-header-cell.titleUpperTable{width:8rem;max-width:8rem}.table-container .table-content .mat-table-dossier-list th.mat-header-cell{background-color:transparent;border:none;position:relative;width:7.8125rem;max-width:7.8125rem}.table-container .table-content .mat-table-dossier-list th.mat-header-cell ::ng-deep .mat-sort-header-container:after{content:\"\\e5d7\";font-family:Material Icons;opacity:.54;transition:opacity .2s linear}.table-container .table-content .mat-table-dossier-list th.mat-header-cell ::ng-deep .mat-sort-header-container:hover:after{opacity:0}.table-container .table-content .mat-table-dossier-list th.mat-header-cell ::ng-deep .mat-sort-header-container.mat-sort-header-sorted:after{opacity:0}.table-container .table-content .mat-table-dossier-list th.mat-header-cell ::ng-deep .mat-sort-header-container{justify-content:center}.table-container .table-content .mat-table-dossier-list th.mat-header-cell ::ng-deep .mat-sort-header-container button{font-size:11px;margin:0;background-color:transparent;white-space:normal}.table-container .table-content .mat-table-dossier-list th.mat-header-cell ::ng-deep .mat-sort-header-container .mat-sort-header-arrow{margin-left:1px}.table-container .table-content .mat-table-dossier-list th.mat-header-cell.mat-sort-header-disabled ::ng-deep .mat-sort-header-container:after{display:none}.table-container .table-content .pagination{width:100%;display:flex;align-items:center;justify-content:center}.table-container .table-content .pagination mat-paginator ::ng-deep .mat-button-wrapper svg{padding-bottom:.3125rem}.table-container .table-content .hide-pagination{display:none}.table-container .table-content td.mat-cell.hasTooltip{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:7.8125rem;width:7.8125rem}.table-container .table-content td.mat-cell.titleUpperTable{min-width:1.5rem;width:1.5rem;max-width:1.5rem;padding:0 .1rem;font-size:12px}.table-container .table-content td.mat-cell.titleUpperTable.largeCol{min-width:7rem;width:7rem;max-width:7rem}.table-container .table-content td.mat-cell.clickable{cursor:pointer;width:30px!important;min-width:30px!important;max-width:30px!important;padding:0;transition-duration:.5s;color:gray}.table-container .table-content tr.clickable{cursor:pointer}.table-container .table-content td.mat-cell.bold{font-weight:700}.table-container .table-content td.mat-cell.fullText{white-space:normal;text-overflow:initial;text-align:left;word-wrap:break-word}.table-container .table-content td.mat-cell{transition-duration:.5s;position:relative;width:7.8125rem;max-width:7.8125rem;white-space:normal;overflow:hidden;text-overflow:ellipsis;text-align:center;word-wrap:break-word;cursor:default;padding:0 2px}.table-container .table-content td.mat-cell :hover{border-bottom:0px}.mat-table-dossier-list th[aria-sort]{font-weight:700}@media only screen and (max-width: 600px){.table-container tr.mat-row td.xs,.table-container th.mat-header-cell.xs{display:none}.pagination mat-paginator ::ng-deep .mat-paginator-container .pageIndex{position:absolute;left:254px}.pagination mat-paginator ::ng-deep .mat-paginator-container .mat-paginator-page-size-label{display:none}}@media only screen and (max-width: 800px){.table-container{overflow:hidden;padding:0}.table-container tr.mat-row td.sm,.table-container th.mat-header-cell.sm{display:none}.table-container .forMobileScroll{position:absolute;height:100%;width:100%;z-index:1}.table-container .table-content th,.table-container .table-content td.mat-cell.clickable{z-index:2}.pagination mat-paginator ::ng-deep .mat-paginator-container{z-index:2}.pagination mat-paginator ::ng-deep .mat-paginator-container .mat-paginator-range-label{margin:0}}@media only screen and (max-width: 1000px){.table-container tr.mat-row td.md,.table-container th.mat-header-cell.md{display:none}}::ng-deep mat-paginator .mat-paginator-page-size-select{width:4rem}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "directive", type: i1$1.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "directive", type: i1$1.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "directive", type: i1$1.NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }, { kind: "ngmodule", type: FormsModule }, { kind: "ngmodule", type: ReactiveFormsModule }, { kind: "ngmodule", type: MatTableModule }, { kind: "component", type: i2$2.MatTable, selector: "mat-table, table[mat-table]", exportAs: ["matTable"] }, { kind: "directive", type: i2$2.MatHeaderCellDef, selector: "[matHeaderCellDef]" }, { kind: "directive", type: i2$2.MatHeaderRowDef, selector: "[matHeaderRowDef]", inputs: ["matHeaderRowDef", "matHeaderRowDefSticky"] }, { kind: "directive", type: i2$2.MatColumnDef, selector: "[matColumnDef]", inputs: ["matColumnDef"] }, { kind: "directive", type: i2$2.MatCellDef, selector: "[matCellDef]" }, { kind: "directive", type: i2$2.MatRowDef, selector: "[matRowDef]", inputs: ["matRowDefColumns", "matRowDefWhen"] }, { kind: "directive", type: i2$2.MatHeaderCell, selector: "mat-header-cell, th[mat-header-cell]" }, { kind: "directive", type: i2$2.MatCell, selector: "mat-cell, td[mat-cell]" }, { kind: "component", type: i2$2.MatHeaderRow, selector: "mat-header-row, tr[mat-header-row]", exportAs: ["matHeaderRow"] }, { kind: "component", type: i2$2.MatRow, selector: "mat-row, tr[mat-row]", exportAs: ["matRow"] }, { kind: "ngmodule", type: MatSortModule }, { kind: "directive", type: i3$1.MatSort, selector: "[matSort]", inputs: ["matSortActive", "matSortStart", "matSortDirection", "matSortDisableClear", "matSortDisabled"], outputs: ["matSortChange"], exportAs: ["matSort"] }, { kind: "component", type: i3$1.MatSortHeader, selector: "[mat-sort-header]", inputs: ["mat-sort-header", "arrowPosition", "start", "disabled", "sortActionDescription", "disableClear"], exportAs: ["matSortHeader"] }, { kind: "ngmodule", type: MatPaginatorModule }, { kind: "component", type: i4$2.MatPaginator, selector: "mat-paginator", inputs: ["color", "pageIndex", "length", "pageSize", "pageSizeOptions", "hidePageSize", "showFirstLastButtons", "selectConfig", "disabled"], outputs: ["page"], exportAs: ["matPaginator"] }, { kind: "ngmodule", type: MatCheckboxModule }, { kind: "component", type: i5$2.MatCheckbox, selector: "mat-checkbox", inputs: ["aria-label", "aria-labelledby", "aria-describedby", "aria-expanded", "aria-controls", "aria-owns", "id", "required", "labelPosition", "name", "value", "disableRipple", "tabIndex", "color", "disabledInteractive", "checked", "disabled", "indeterminate"], outputs: ["change", "indeterminateChange"], exportAs: ["matCheckbox"] }, { kind: "ngmodule", type: MatIconModule }, { kind: "component", type: i5$1.MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }, { kind: "ngmodule", type: MatTooltipModule }, { kind: "directive", type: i5.MatTooltip, selector: "[matTooltip]", inputs: ["matTooltipPosition", "matTooltipPositionAtOrigin", "matTooltipDisabled", "matTooltipShowDelay", "matTooltipHideDelay", "matTooltipTouchGestures", "matTooltip", "matTooltipClass"], exportAs: ["matTooltip"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: Table, decorators: [{
            type: Component,
            args: [{ selector: 'dia-table', standalone: true, imports: [
                        CommonModule,
                        FormsModule,
                        ReactiveFormsModule,
                        MatTableModule,
